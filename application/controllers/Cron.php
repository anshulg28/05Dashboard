    ...
    public function sendWalletUseReport()
    {
        ...
        if( isset($allFeedbacks) && myIsArray($allFeedbacks))
        {
            ...
            foreach($allFeedbacks as $key => $row)
            {
                ...
                elseif($row['userType'] == WALLET_GUEST)
                {
                    $userType = 'Guest User';
                }
            ...
            $this->sendemail_library->sendEmail(array('tresha@brewcraftsindia.com','swati@brewcraftsindia.com','saha@brewcraftsindia.com','savio@brewcraftsindia.com','suketu@brewcraftsindia.com','finance@brewcraftsindia.com','jayant@brewcraftsindia.com'),'','admin@brewcraftsindia.com','ngks2009','Doolally'
