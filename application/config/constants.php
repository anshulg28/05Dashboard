...
defined('ON_HOLD')   OR define('ON_HOLD', 2);
...
defined('WALLET_RESTAURANT') OR define('WALLET_RESTAURANT','1');
defined('WALLET_OFFICE') OR define('WALLET_OFFICE','2');
defined('WALLET_GUEST') OR define('WALLET_GUEST','3');
defined('WALLET_GUEST_VALIDITY') OR define('WALLET_GUEST_VALIDITY','4');
defined('OFFICE_WALLET_CAP') OR define('OFFICE_WALLET_CAP',7500);
