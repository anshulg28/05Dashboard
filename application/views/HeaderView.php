    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle my-keepRelative" data-toggle="dropdown" href="#"><i class="fa fa-bars"></i> Menu
                        <span class="caret"></span><div class="notification-indicator"></div></a>
                    <ul class="dropdown-menu">
                        ...
                        if(isSessionVariableSet($this->isUserSession) === true)
                        {
                            ...
                            {
                                ?>
                                <li class="my-keepRelative"><a href="<?php echo base_url();?>mailers"><i class="fa fa-envelope"></i> Mailers</a>
