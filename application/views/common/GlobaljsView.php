...
$(document).on('click','.homePage .request-otp', function(){
    ...
    function createEventsHigh(eventData)
    {
        ...
        var eveVenueName = 'Doolally Taproom - '+eventData.locName;
        ...
        //Saving request before starting
        $.ajax({
            type: 'POST',
            dataType: 'json',
            async: false,
            url:base_url+'dashboard/saveClientLog',
            data:{msg: JSON.stringify(postData), reqStatus: 'Url: '+ errUrl+' status: starting'},
            success: function(data){},
            error: function(){}
        });
        ...
        $.ajax({
            ...
            async: false,
            success: function(data){
                 //Saving request after success
                $.ajax({
                    type: 'POST',
                    dataType: 'json',
                    url:base_url+'dashboard/saveClientLog',
                    data:{msg: JSON.stringify(postData), reqStatus: 'Url: '+ errUrl+' status: success, data: '+JSON.stringify(data)},
                    success: function(data){},
                    error: function(){}
                });
                            ...
                            if(typeof jPar.dupes !== 'undefined')
                            {
                                ...
                                $.ajax({
                                    ...
                                    error: function(xhr, status, error){
                                        //hideCustomLoader();
                                        //bootbox.alert('Some Error Occurred!');
                                        var err = 'Line: 583 Url: '+errUrl+' StatusText: '+xhr.statusText+' Status: '+xhr.status+' resp: '+xhr.responseText;
                                        saveErrorLog(err);
                                    }
                                });
                ...
                if(typeof eventData.highId !== 'undefined')
                {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error){
                            ...
                            var err = 'Line: 615 Url: '+errUrl+' StatusText: '+xhr.statusText+' Status: '+xhr.status+' resp: '+xhr.responseText;
                            saveErrorLog(err);
                        }
                    });
                }
                else
                {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error){
                            ...
                            var err = 'Line: 647 Url: '+errUrl+' StatusText: '+xhr.statusText+' Status: '+xhr.status+' resp: '+xhr.responseText;
                            saveErrorLog(err);
                        }
                    });
                }
            ...
            error: function(xhr, status, error){
                hideCustomLoader();
                bootbox.alert('Failed to push event data on Eventshigh, Please edit event once and try again!');
                var err = 'Line: 656 Url: '+errUrl+' StatusText: '+xhr.statusText+' Status: '+xhr.status+' resp: '+xhr.responseText;
                saveErrorLog(err);
            }
        });
    }
