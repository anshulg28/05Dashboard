...
<p>
    Your event <?php echo $mailData[0]['eventName'];?> has been cancelled.
    <?php
        if($mailData[0]['costType'] != EVENT_FREE)
        {
            ?>
            Fees collected will be refunded to participants within 7 days.
            However, the payment gateway fee of 2.24 % ( In the case of a Doolally sign up) or 5 % (In the case of an EventsHigh sign up) per attendee will be borne by you.
            <br>
