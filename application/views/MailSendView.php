                                                ...
                                                <?php
                                                    foreach($locArr as $key => $row)
                                                    {
                                                        ...
                                                        <li class="my-pointer-item">
                                                            <span class="label label-success">[<?php echo $row['locName'];?>_docode]</span>
                                                        </li>
                                                        <?php
                                                    }
                                                ?>
                                                <li class="my-pointer-item"><span class="label label-success">[extendexpiryby3]</span></li>
                                                <li class="my-pointer-item"><span class="label label-success">[extendexpiryby6]</span></li>
                                            </ul>
                                        </div>
                                    </form>
                                </div>
