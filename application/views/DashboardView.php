...
<script>
    ...
    $(document).on('click','#eventPrice-modal .save-event-price', function(){
        $('#eventPrice-modal .save-event-price').attr('disabled','disabled');
        ...
        if(selectedType != '1')
        {
            ...
            {
                $('#eventPrice-modal .save-event-price').removeAttr('disabled');
...
<script>
    ...
    var newOrgTab = $('#org-new-table').DataTable({
        ...
        ajax:
            {
                url : base_url+'dashboard/getOrgCollection/1'
            },
        ordering: false,
        deferRender: true
//        ordering: false,
...
//        }
    ...
    $(document).on('click','#orgSum .viewDetails-icon', function(e){
        ...
        if(oldNames.length>0 && oldNames[0] != '')
        {
